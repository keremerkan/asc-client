...
struct InstallSkillCommand: ParsableCommand {
  ...
  func run() throws {
    ...
    print()
    print("For other AI tools, the skill file is also available in the repository:")
    print("  https://github.com/keremerkan/asc-client/tree/main/skills/asc-client/SKILL.md")
  }
...
// To update: edit skills/asc-client/SKILL.md and copy the content here.
